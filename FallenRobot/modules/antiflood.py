...
__help__ = """
» *Anti-flood için bulunan komutlar* :

══════════════════════════════

» Anti-flood, art arda x'ten fazla mesaj gönderen kullanıcılar hakkında işlem yapmanızı sağlar. Ayarlanan selin aşılması, o kullanıcının kısıtlanmasına neden olur. Bu, art arda 10'dan fazla mesaj gönderirlerse kullanıcıları susturur, botlar göz ardı edilir. 

══════════════════════════════

❍ /flood: Geçerli taşma kontrolü ayarını alın

   • Yalnızca yöneticiler: 

──────────────────────────────

❍ /setflood no/off: Flood kontrolünü devre dışı bırakır.

❍ /setflood (değer): Flood kontrolünüzü etkinleştirir 

   • Örnek: /setflood 10

──────────────────────────────

❍ /setfloodmode (ban/kick/mute/tban/tmute) (değer): Kullanıcı flood sınırını aştığında gerçekleştirilecek eylem.

──────────────────────────────

❍*Not*: Sadece tban ve tmute için değer doldurulmalıdır!! 
